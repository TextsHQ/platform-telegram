...
export default class TelegramMapper {
  ...
  mapMessageLink(webPage: Api.TypeWebPage, imgKey?: string | number) {
    ...
    if (photo instanceof Api.Photo && !photo.videoSizes?.length) {
  ...
  mapMessage(msg: CustomMessage | Api.Message | Api.MessageService, readOutboxMaxId: number): Message {
    ...
    const mapped: Message = {
      ...
      forwardedFrom: msg.fwdFrom ? { userID: getPeerId(msg.fwdFrom.fromId), text: msg.fwdFrom.fromName } : undefined,
      senderID,
      isSender,
